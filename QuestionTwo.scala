...
object QuestionTwo {
  def main(args: Array[String]): Unit = {
    ...
    val query = "SELECT businessTable.business_id, full_address, categories, AVG(rating) as avg_rating " +
                "FROM (businessTable INNER JOIN reviewTable ON businessTable.business_id = reviewTable.business_id) " +
                "GROUP BY businessTable.business_id, full_address, categories " +
